...
| H2 sections | **≥${QUALITY_MIN_H2}** H2s before FAQ, plus FAQ (4–5 H3s) and final **QApilot** closing H2 |
| QApilot mentions | **≥${QUALITY_MIN_QAPILOT_MENTIONS}** mentions of QApilot across the piece (not only the last paragraph) |
| Internal links | **${QUALITY_MIN_INTERNAL_LINKS}–${QUALITY_MAX_INTERNAL_LINKS}** inline \`[text](https://qapilot.io/...)\` links from the candidate list |
