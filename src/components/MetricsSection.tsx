    ...
    <section className="relative overflow-hidden section-edge w-full">
      <div className="section-navy w-full">
        <div className="section-full py-8 sm:py-10 md:py-12 2xl:py-16 relative">
          ...
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-left text-primary-foreground/60 mb-3 md:mb-4 relative z-10">
            At scale
          </p>
          <h2
            className={cn(
              marketingSectionH2Class,
              "text-left relative z-10 px-2 mb-4 md:mb-5",
            )}
          >
