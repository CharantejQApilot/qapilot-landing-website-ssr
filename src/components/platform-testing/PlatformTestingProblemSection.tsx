...
export function PlatformTestingProblemSection({ content }: { content: PlatformTestingContent }) {
  return (
    <section
      ...
      aria-labelledby={`${content.slug}-problems-heading`}
    >
      <div className="section-full relative z-10 py-14 md:py-20 2xl:py-24">
        <MarketingSectionHeader
          id={`${content.slug}-problems-heading`}
          title={
            <>
              {content.problemHeadingBefore}{" "}
              <span className="text-primary">{content.problemHeadingAccent}</span> Breaks
            </>
          }
