...
import { PlatformHeroLeadForm } from "@/components/platform-testing/PlatformHeroLeadForm";
...
export function PlatformTestingHero({ content }: { content: PlatformTestingContent }) {
  return (
    <section
        ...
        >
          <div className="flex min-w-0 flex-col items-start text-left lg:max-w-none lg:pr-2 xl:pr-4">
            ...
            <h1 className={cn(marketingHeroH1Class, "mb-5 w-full text-left text-balance sm:mb-6 md:mb-8")}>
              {content.h1Before}{" "}
              <span className="text-primary">{content.h1Accent}</span>
            </h1>
            <p
              className={cn(
          ...
          <div id={content.demoAnchorId} className="min-w-0 w-full scroll-mt-28 lg:pl-2 xl:pl-4">
            <div
              className={cn(
            ...
            >
              <div className="relative z-[1] space-y-1.5 pb-5 sm:pb-6">
                <h2 className={marketingFormTitleClass}>{content.formTitle}</h2>
              ...
              <div className="relative z-[1] min-h-0 min-w-0 flex-1 rounded-xl border border-border/40 bg-background/70 p-3 sm:p-4 md:p-5">
                <PlatformHeroLeadForm
                  pageName={content.formPageName}
                  fieldIdPrefix={content.formFieldPrefix}
                />
              </div>
            </div>
          </div>
