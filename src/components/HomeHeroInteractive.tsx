...
export default function HomeHeroInteractive() {
  ...
  return (
    <>
      ...
      >
        <span className="flex flex-col items-center gap-y-2 sm:gap-y-2.5 md:gap-y-3 max-lg:gap-y-2 max-lg:sm:gap-y-2.5 max-lg:md:gap-y-3">
      ...
      <div className="mb-0">
        <Button
          ...
          className={cn(
            ...
            "max-lg:px-10 max-lg:py-6 max-lg:text-lg max-lg:shadow-xl max-lg:shadow-primary/30",
            "max-lg:sm:px-12 max-lg:sm:py-7 max-lg:sm:text-xl",
          )}
        >
          Book a Demo
        </Button>
