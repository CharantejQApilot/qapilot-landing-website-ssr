...
const BYOAHeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 pb-8">
      {/* Background Effects */}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 700" fill="none">
                <defs>
                  ...
                  <path id="circuit-path-nav" d="M 150 200 L 450 200 L 450 280 L 520 280" />
                  <path id="circuit-path-test" d="M 150 350 L 300 350 L 300 280 L 520 280" />
                  <path id="circuit-path-access" d="M 150 500 L 450 500 L 450 420 L 520 420" />
                  
                  {/* QApilot Framework to outputs */}
                  <path id="circuit-path-out1" d="M 680 280 L 750 280 L 750 200 L 1050 200" />
                  <path id="circuit-path-out2" d="M 680 350 L 900 350 L 900 280 L 1050 280" />
                  <path id="circuit-path-out3" d="M 680 420 L 750 420 L 750 500 L 1050 500" />
                  
                  {/* BYOA agents to framework */}
                  <path id="circuit-path-byoa1" d="M 150 280 L 520 280" />
                  <path id="circuit-path-byoa2" d="M 150 420 L 520 420" />
                </defs>
                ...
                <circle r="5" fill="hsl(var(--primary))" className="opacity-0">
                  <animateMotion dur="3s" repeatCount="indefinite" begin="1s">
                    <mpath href="#circuit-path-access" />
                  </animateMotion>
...
export default BYOAHeroSection;
