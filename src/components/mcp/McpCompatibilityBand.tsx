...
function Pill({ children }: { children: ReactNode }) {
  return (
    <span className="inline-flex shrink-0 items-center rounded-md border border-border/80 bg-card px-3 py-1.5 text-xs font-semibold tracking-tight text-foreground sm:text-sm">
      {children}
    </span>
  );
}
