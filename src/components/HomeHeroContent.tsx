...
export default function HomeHeroContent() {
  return (
    <div className="flex h-full min-h-0 w-full min-w-0 flex-1 flex-col items-center lg:items-stretch">
      <HomeHeroExploreStage>
        <HomeHeroLandingPanel />
      </HomeHeroExploreStage>

      <div className="sig-cta-row mt-6 w-full shrink-0 justify-center sm:mt-8 md:mt-8 lg:justify-start">
        <HomeHeroDemoButton />
      </div>
    </div>
  );
