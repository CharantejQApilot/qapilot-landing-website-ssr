    ...
    >
      <div className="section-full relative z-10 py-14 md:py-20 2xl:py-24">
        <MarketingSectionHeader
          ...
          title={
            <>
              Specialized Agents, <span className="text-primary">Working Together</span>
            </>
          }
        ...
        <div className={cn("mx-auto mt-12 max-w-3xl space-y-6 text-center", marketingSectionIntroClass)}>
          <p>
            Each agent{" "}
            <span className="font-medium text-foreground">
              reads from the knowledge graph, writes back new insights, and improves system understanding.
            </span>
          </p>
