          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6 lg:grid-cols-12 lg:gap-6">
            {originStoryBeats.map((beat, index) => {
              ...
              return (
                ...
                >
                  <span
                    className="absolute bottom-0 left-0 top-0 w-1 bg-primary/90"
                    aria-hidden
                  />
                  <div
                    className={cn(
                      "relative flex h-full flex-col pl-4 md:pl-5",
                      isLead && "lg:pr-4",
                    )}
                  >
            ...
            >
              <span
                className="absolute bottom-0 left-0 top-0 w-1.5 bg-primary"
                aria-hidden
              />
      ...
      >
        <div className="section-full py-14 md:py-20 2xl:py-24">
          ...
          >
            ...
            value being present. Not just online, but in real conversations with
          ...
          <ul className="mb-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              {
                text: "Participating in builder communities",
                Icon: MessageSquare,
              },
              {
                text: "Touching grass occasionally",
                Icon: TreePine,
                italic: true,
              },
          ...
          <div className="flex justify-center">
            <div className="rounded-full border border-border/80 bg-card/80 px-8 py-4 shadow-sm backdrop-blur-sm">
              <p className="text-center text-base font-medium text-foreground md:text-lg">
                This mix keeps us{" "}
                <span className="font-bold text-primary">grounded</span> and{" "}
          ...
          <div className="flex items-center justify-center gap-2">
            <div className="flex -space-x-2">
              {[0, 1, 2, 3, 4].map((i) => (
                ...
                >
                  <Sparkles
                    className="h-3 w-3 text-muted-foreground/50 md:h-4 md:w-4"
                    aria-hidden
                  />
                </div>
              ))}
