...
export const metadata: Metadata = {
  ...
  description:
    "Integrate your own AI agents into QApilot and use the shared knowledge graph for custom validation and specialized testing without breaking the core system.",
  alternates: {
