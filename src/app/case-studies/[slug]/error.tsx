 ...
 * published case study degrades gracefully instead of escalating to Next's
 * generic /500 page. Required to be a client component by Next App Router.
 */
export default function CaseStudyError({
  ...
  useEffect(() => {
    if (typeof console !== "undefined") {
      console.error("[/case-studies/[slug]] render error:", error);
    }
  }, [error]);
  ...
  return (
    <main className="mx-auto flex min-h-[60vh] w-full max-w-3xl flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <p className="mb-8 max-w-xl text-muted-foreground">
        Something on our side hiccuped while preparing this page. The story is
        still here — please retry, or head back to all case studies.
      </p>
