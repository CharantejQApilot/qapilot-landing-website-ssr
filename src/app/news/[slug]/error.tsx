 ...
 * published news item degrades gracefully instead of escalating to Next's
 * generic /500 page.
 */
export default function NewsPostError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    if (typeof console !== "undefined") {
      console.error("[/news/[slug]] render error:", error);
    }
  }, [error]);
