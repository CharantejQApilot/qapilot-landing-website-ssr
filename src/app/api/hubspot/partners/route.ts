...
import { HUBSPOT_PARTNERS_FORM_ID, HUBSPOT_NA1_PORTAL_ID } from "@/lib/constants";
...
export async function POST(request: Request) {
  ...
  const formGuid = process.env.HUBSPOT_PARTNERS_FORM_GUID ?? HUBSPOT_PARTNERS_FORM_ID;
